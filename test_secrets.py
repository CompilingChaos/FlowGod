...
async def run_comprehensive_test():
    print("--- Starting 17-Char Layout Integration Test ---")
    ...
    # 4. Test Telegram Notification (17-char Layout)
    print("🔹 Testing 17-Char Template...")
    ...
    if tg_token and tg_chat_id:
        try:
            ...
            final_msg = (
                f"🧪 <b>TEST: {fake_ticker} (17-CHAR UI)</b>\n"
                f"{insider_tag}\n"
                f"━━━━━━━━━━━━━━━━━\n"
